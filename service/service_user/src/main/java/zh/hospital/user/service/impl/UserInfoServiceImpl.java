...
import zh.hospital.enums.AuthStatusEnum;
import zh.hospital.model.user.Patient;
import zh.hospital.model.user.UserInfo;
import zh.hospital.user.mapper.UserInfoMapper;
import zh.hospital.user.service.PatientService;
import zh.hospital.user.service.UserInfoService;
import zh.hospital.vo.user.LoginVo;
import zh.hospital.vo.user.UserAuthVo;
import zh.hospital.vo.user.UserInfoQueryVo;
